...
- **Frontend Agent:** React 19, Vite, TanStack Query/Router/Table, Tailwind CSS v4, Zod validation, HR UI/UX, HCI Guidelines ([`.agents/skills/frontend-hci/SKILL.md`](../skills/frontend-hci/SKILL.md)).
- **AI/RAG Agent:** Gemini API, Xenova Transformers embeddings, pgvector cosine similarity, scoring revalidation.
- **Reviewer/QA Agent:** Security audits, deterministic contract checks, integration testing, 10-point HCI checklist.
...
7. Verify the implementation before declaring completion (including the 10-point HCI review checklist for UI).
8. Prefer simple, readable solutions over unnecessary abstractions.
9. Do not overengineer the capstone.
10. Strictly prevent AI-generated UI slop, excessive cards/gradients/badges, and technical jargon in user-facing UI.
