...
describe("Analytics Components Test Suite", () => {
  ...
  it("renders RecruitmentFunnel stages and conversion rates", () => {
    ...
    expect(screen.getByText("Hiring Funnel")).toBeDefined();
    expect(screen.getByText("Candidate progression through each hiring stage")).toBeDefined();
    ...
    expect(screen.getAllByText("Total Yield:").length).toBeGreaterThan(0);
  ...
  it("renders BottlenecksWidget with aging and SLA breach flags", () => {
    ...
    expect(screen.getByText("Pipeline Review Bottlenecks")).toBeDefined();
    expect(screen.getByText("Stages where candidate reviews exceed target SLAs")).toBeDefined();
    expect(screen.getByText("Initial Screening")).toBeDefined();
    expect(screen.getByText("CRITICAL")).toBeDefined();
    expect(screen.getByText("Average Time in Stage:")).toBeDefined();
    expect(screen.getByText("Target Review SLA:")).toBeDefined();
    expect(screen.getByText("Overdue Reviews:")).toBeDefined();
