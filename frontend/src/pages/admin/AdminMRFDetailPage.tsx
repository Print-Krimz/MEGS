...
type AdminMRFDetailTab = "deployments" | "jobs" | "specifications";

export const AdminMRFDetailPage: React.FC = () => {
  const { mrfId } = useParams({ strict: false }) as { mrfId: string };

  const [activeTab, setActiveTab] = useState<AdminMRFDetailTab>("deployments");
        ...
        >
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="space-y-6">
              ...
              {/* Compliance Requirement Templates (Read-Only) */}
