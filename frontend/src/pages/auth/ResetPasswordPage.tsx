...
import { Eye, EyeOff, Lock, Loader2, AlertCircle, KeyRound, ArrowLeft, ShieldAlert } from 'lucide-react';
...
export default function ResetPasswordPage() {
  ...
  // Extract token from either search params or hash fragments
  const token = useMemo(() => {
      ...
      >
        ...
        <div className="space-y-2">
          ...
          <p className="text-sm font-medium text-amber-900/80 max-w-sm mx-auto leading-relaxed">
            This password recovery link is invalid, incomplete, or has expired. Password reset links are single-use only.
          </p>
        </div>
        ...
        <div className="pt-2 space-y-2.5">
          ...
          <Link
            to="/login"
            className="w-full h-10 inline-flex items-center justify-center py-2 px-4 bg-white hover:bg-slate-50 border border-slate-200 text-slate-700 font-medium text-sm rounded-lg transition"
          >
            Return to Sign In
          </Link>
        </div>
        ...
        <div className="space-y-1.5">
          ...
          <div className="relative">
            ...
            <button
              ...
              aria-label={showPassword ? 'Hide new password visibility' : 'Show new password visibility'}
